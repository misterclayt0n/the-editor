...
bool the_editor_split_active_pane_vertical(the_editor_handle_t *handle);
bool the_editor_split_active_pane_horizontal(the_editor_handle_t *handle);
bool the_editor_close_active_pane_item(the_editor_handle_t *handle);
...
bool the_editor_move_open_item(the_editor_handle_t *handle, uintptr_t source_pane_id, uint8_t kind, uintptr_t item_id, uintptr_t target_pane_id, uintptr_t target_index);
