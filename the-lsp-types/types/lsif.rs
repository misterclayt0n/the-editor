...
pub enum DocumentSymbolOrRangeBasedVec {
  DocumentSymbol(Vec<crate::types::DocumentSymbol>),
...
pub struct DefinitionTag {
  ...
  /// but everything else, e.g comments and code. The range must be included
  /// in fullRange.
  full_range: Range,
...
pub enum Vertex {
  ...
  FoldingRangeResult {
    result: Vec<crate::types::FoldingRange>,
  },
  HoverResult {
    result: crate::types::Hover,
  },
  DocumentSymbolResult {
    result: DocumentSymbolOrRangeBasedVec,
  },
  DocumentLinkResult {
    result: Vec<crate::types::DocumentLink>,
  },
  DiagnosticResult {
