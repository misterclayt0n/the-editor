...
macro_rules! lsp_request {
  ("initialize") => {
    $crate::types::request::Initialize
  };
  ("shutdown") => {
    $crate::types::request::Shutdown
  };

  ("window/showMessageRequest") => {
    $crate::types::request::ShowMessageRequest
  };

  ("client/registerCapability") => {
    $crate::types::request::RegisterCapability
  };
  ("client/unregisterCapability") => {
    $crate::types::request::UnregisterCapability
  };

  ("workspace/symbol") => {
    $crate::types::request::WorkspaceSymbolRequest
  };
  ("workspaceSymbol/resolve") => {
    $crate::types::request::WorkspaceSymbolResolve
  };
  ("workspace/executeCommand") => {
    $crate::types::request::ExecuteCommand
  };

  ("textDocument/willSaveWaitUntil") => {
    $crate::types::request::WillSaveWaitUntil
  };

  ("textDocument/completion") => {
    $crate::types::request::Completion
  };
  ("completionItem/resolve") => {
    $crate::types::request::ResolveCompletionItem
  };
  ("textDocument/hover") => {
    $crate::types::request::HoverRequest
  };
  ("textDocument/signatureHelp") => {
    $crate::types::request::SignatureHelpRequest
  };
  ("textDocument/declaration") => {
    $crate::types::request::GotoDeclaration
  };
  ("textDocument/definition") => {
    $crate::types::request::GotoDefinition
  };
  ("textDocument/references") => {
    $crate::types::request::References
  };
  ("textDocument/documentHighlight") => {
    $crate::types::request::DocumentHighlightRequest
  };
  ("textDocument/documentSymbol") => {
    $crate::types::request::DocumentSymbolRequest
  };
  ("textDocument/codeAction") => {
    $crate::types::request::CodeActionRequest
  };
  ("textDocument/codeLens") => {
    $crate::types::request::CodeLensRequest
  };
  ("codeLens/resolve") => {
    $crate::types::request::CodeLensResolve
  };
  ("textDocument/documentLink") => {
    $crate::types::request::DocumentLinkRequest
  };
  ("documentLink/resolve") => {
    $crate::types::request::DocumentLinkResolve
  };
  ("workspace/applyEdit") => {
    $crate::types::request::ApplyWorkspaceEdit
  };
  ("textDocument/rangeFormatting") => {
    $crate::types::request::RangeFormatting
  };
  ("textDocument/onTypeFormatting") => {
    $crate::types::request::OnTypeFormatting
  };
  ("textDocument/formatting") => {
    $crate::types::request::Formatting
  };
  ("textDocument/rename") => {
    $crate::types::request::Rename
  };
  ("textDocument/documentColor") => {
    $crate::types::request::DocumentColor
  };
  ("textDocument/colorPresentation") => {
    $crate::types::request::ColorPresentationRequest
  };
  ("textDocument/foldingRange") => {
    $crate::types::request::FoldingRangeRequest
  };
  ("textDocument/prepareRename") => {
    $crate::types::request::PrepareRenameRequest
  };
  ("textDocument/implementation") => {
    $crate::types::request::GotoImplementation
  };
  ("textDocument/typeDefinition") => {
    $crate::types::request::GotoTypeDefinition
  };
  ("textDocument/selectionRange") => {
    $crate::types::request::SelectionRangeRequest
  };
  ("workspace/workspaceFolders") => {
    $crate::types::request::WorkspaceFoldersRequest
  };
  ("workspace/configuration") => {
    $crate::types::request::WorkspaceConfiguration
  };
  ("window/workDoneProgress/create") => {
    $crate::types::request::WorkDoneProgressCreate
  };
  ("callHierarchy/incomingCalls") => {
    $crate::types::request::CallHierarchyIncomingCalls
  };
  ("callHierarchy/outgoingCalls") => {
    $crate::types::request::CallHierarchyOutgoingCalls
  };
  ("textDocument/moniker") => {
    $crate::types::request::MonikerRequest
  };
  ("textDocument/linkedEditingRange") => {
    $crate::types::request::LinkedEditingRange
  };
  ("textDocument/prepareCallHierarchy") => {
    $crate::types::request::CallHierarchyPrepare
  };
  ("textDocument/prepareTypeHierarchy") => {
    $crate::types::request::TypeHierarchyPrepare
  };
  ("textDocument/semanticTokens/full") => {
    $crate::types::request::SemanticTokensFullRequest
  };
  ("textDocument/semanticTokens/full/delta") => {
    $crate::types::request::SemanticTokensFullDeltaRequest
  };
  ("textDocument/semanticTokens/range") => {
    $crate::types::request::SemanticTokensRangeRequest
  };
  ("textDocument/inlayHint") => {
    $crate::types::request::InlayHintRequest
  };
  ("textDocument/inlineValue") => {
    $crate::types::request::InlineValueRequest
  };
  ("textDocument/diagnostic") => {
    $crate::types::request::DocumentDiagnosticRequest
  };
  ("workspace/diagnostic") => {
    $crate::types::request::WorkspaceDiagnosticRequest
  };
  ("workspace/diagnostic/refresh") => {
    $crate::types::request::WorkspaceDiagnosticRefresh
  };
  ("typeHierarchy/supertypes") => {
    $crate::types::request::TypeHierarchySupertypes
  };
  ("typeHierarchy/subtypes") => {
    $crate::types::request::TypeHierarchySubtypes
  };
  ("workspace/willCreateFiles") => {
    $crate::types::request::WillCreateFiles
  };
  ("workspace/willRenameFiles") => {
    $crate::types::request::WillRenameFiles
  };
  ("workspace/willDeleteFiles") => {
    $crate::types::request::WillDeleteFiles
  };
  ("workspace/semanticTokens/refresh") => {
    $crate::types::request::SemanticTokensRefresh
  };
  ("workspace/codeLens/refresh") => {
    $crate::types::request::CodeLensRefresh
  };
  ("workspace/inlayHint/refresh") => {
    $crate::types::request::InlayHintRefreshRequest
  };
  ("workspace/inlineValue/refresh") => {
    $crate::types::request::InlineValueRefreshRequest
  };
  ("codeAction/resolve") => {
    $crate::types::request::CodeActionResolveRequest
  };
  ("inlayHint/resolve") => {
    $crate::types::request::InlayHintResolveRequest
  };
  ("window/showDocument") => {
    $crate::types::request::ShowDocument
  };
}

/// The initialize request is sent as the first request from the client to the
/// server. If the server receives request or notification before the
...
/// client to unregister a previously register capability.
#[derive(Debug)]
...
/// as a param. The returned completion item should have the documentation
/// property filled in. The request can delay the computation of the detail and
/// documentation properties. However, properties that are needed for the
/// initial sorting and filtering, like sortText, filterText, insertText,
/// and textEdit must be provided in the textDocument/completion request and
...
/// The goto declaration request is sent from the client to the server to
...
/// allowed to be more fuzzy. Symbol matches usually have a
/// DocumentHighlightKind of Read or Write whereas fuzzy or textual matches
...
/// The `workspaceSymbol/resolve` request is sent from the client to the server
/// to resolve additional information for a given workspace symbol.
#[derive(Debug)]
...
/// if a server constantly fails on this request. This is done to keep the
...
/// used be the client. So a server might ask for a configuration
...
/// the provided resource. If the client for example uses EditorConfig to manage
/// its settings the configuration should be returned for the passed resource
/// URI. If the client can’t provide a configuration setting for a given scope
/// then null need to be present in the returned array.
#[derive(Debug)]
...
/// the user moves the cursor into a problem marker in the editor or presses the
...
/// result-specific word pattern is provided, the word pattern from the client’s
...
/// color value in RGB is returned.
#[derive(Debug)]
...
/// to fetch the current open list of workspace folders. Returns null in the
/// response if only a single file is open in the tool. Returns an empty array
...
/// ask the server to recompute the semantic tokens for these editors.
/// This is useful if a server detects a project wide configuration change which
/// requires a re-calculation of all semantic tokens. Note that the client still
/// has the freedom to delay the re-calculation of the semantic tokens if for
...
/// the client. The request can return a WorkspaceEdit which will be applied to
/// workspace before the files are renamed. Please note that clients might drop
/// results if computing the edit took too long or if a server constantly fails
/// on this request. This is done to keep renames fast and reliable.
...
/// the client. The request can return a WorkspaceEdit which will be applied to
/// workspace before the files are deleted. Please note that clients might drop
/// results if computing the edit took too long or if a server constantly fails
/// on this request. This is done to keep deletes fast and reliable.
...
/// The `inlayHint/resolve` request is sent from the client to the server to
/// resolve additional information for a given inlay hint. This is usually used
/// to compute the tooltip, location or command properties of a inlay hint’s
/// label part to avoid its unnecessary computation during the `textDocument/
/// inlayHint` request.
...
/// currently shown in editors. As a result the client should ask the server to
/// recompute the inline values for these editors. This is useful if
/// a server detects a configuration change which requires a re-calculation of
...
/// pushed from the server to the client. In contrast to the document diagnostic
/// request the workspace request can be long running and is not bound to a
/// specific workspace or document state. If the client supports streaming for
/// the workspace diagnostic pull it is legal to provide a document diagnostic
/// report multiple times for the same document URI. The last one reported will
...
/// client. Servers can use it to ask clients to refresh all needed document and
/// workspace diagnostics. This is useful if a server detects a project wide
...
/// type hierarchy for the language element of given text document positions.
...
///
/// 1. first a type hierarchy item is prepared for the given text document
///    position.
...
/// The `typeHierarchy/supertypes` request is sent from the client to the server
/// to resolve the supertypes for a given type hierarchy item. Will return null
/// if the server couldn’t infer a valid type from item in the params. The
/// request doesn’t define its own client and server capabilities. It is only
/// issued if a server registers for the `textDocument/prepareTypeHierarchy`
/// request.
...
/// The `typeHierarchy/subtypes` request is sent from the client to the server
/// to resolve the subtypes for a given type hierarchy item. Will return null if
/// the server couldn’t infer a valid type from item in the params. The request
/// doesn’t define its own client and server capabilities. It is only issued if
/// a server registers for the textDocument/prepareTypeHierarchy request.
