...
typedef struct __swift_bridge__$DocsPopupAnchor { bool has_value; uint64_t pane_id; uint16_t row; uint16_t col; } __swift_bridge__$DocsPopupAnchor;
typedef struct __swift_bridge__$Option$DocsPopupAnchor { bool is_some; __swift_bridge__$DocsPopupAnchor val; } __swift_bridge__$Option$DocsPopupAnchor;
...
struct __swift_bridge__$DocsPopupAnchor __swift_bridge__$App$docs_popup_anchor(void* self, struct __swift_bridge__$EditorId id);
...
uintptr_t __swift_bridge__$App$file_picker_list_offset(void* self, struct __swift_bridge__$EditorId id);
uintptr_t __swift_bridge__$App$file_picker_list_visible(void* self, struct __swift_bridge__$EditorId id);
bool __swift_bridge__$App$file_picker_set_list_offset(void* self, struct __swift_bridge__$EditorId id, uintptr_t offset);
bool __swift_bridge__$App$file_picker_set_visible_rows(void* self, struct __swift_bridge__$EditorId id, uintptr_t visible_rows);
bool __swift_bridge__$App$file_picker_move_selection(void* self, struct __swift_bridge__$EditorId id, int64_t delta);
...
uint64_t __swift_bridge__$RenderPlan$layout_generation(void* self);
uint64_t __swift_bridge__$RenderPlan$text_generation(void* self);
uint64_t __swift_bridge__$RenderPlan$decoration_generation(void* self);
uint64_t __swift_bridge__$RenderPlan$cursor_generation(void* self);
uint64_t __swift_bridge__$RenderPlan$scroll_generation(void* self);
uint64_t __swift_bridge__$RenderPlan$theme_generation(void* self);
uint16_t __swift_bridge__$RenderPlan$damage_start_row(void* self);
uint16_t __swift_bridge__$RenderPlan$damage_end_row(void* self);
bool __swift_bridge__$RenderPlan$damage_is_full(void* self);
uint8_t __swift_bridge__$RenderPlan$damage_reason(void* self);
...
uint64_t __swift_bridge__$RenderFramePlan$frame_generation(void* self);
uint64_t __swift_bridge__$RenderFramePlan$pane_structure_generation(void* self);
...
uintptr_t __swift_bridge__$RenderFramePlan$changed_pane_count(void* self);
uint64_t __swift_bridge__$RenderFramePlan$changed_pane_id_at(void* self, uintptr_t index);
bool __swift_bridge__$RenderFramePlan$damage_is_full(void* self);
uint8_t __swift_bridge__$RenderFramePlan$damage_reason(void* self);
...
uint64_t __swift_bridge__$FileTreeSnapshotData$vcs_generation(void* self);
...
uint8_t __swift_bridge__$FileTreeNodeFFI$vcs_status(void* self);
uintptr_t __swift_bridge__$FileTreeNodeFFI$vcs_descendant_count(void* self);
...
uintptr_t __swift_bridge__$FilePickerSnapshotData$list_offset(void* self);
uintptr_t __swift_bridge__$FilePickerSnapshotData$list_visible(void* self);
