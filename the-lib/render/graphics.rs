...
/// A simple rectangle used in the computation of the layout and to give widgets
/// an hint about the area they are supposed to render to. (x, y) = (0, 0) is at
...
bitflags! {
    ...
    ///
    /// ```rust
    /// # use the_lib::render::graphics::Modifier;
    ///
...
///
/// ```rust
/// # use the_lib::render::graphics::{Color, Modifier, Style};
/// Style::default()
///   .fg(Color::Black)
///   .bg(Color::Green)
...
impl Style {
  ...
  ///
  /// ```rust
  /// # use the_lib::render::graphics::{Color, Style};
  ...
  ///
  /// ```rust
  /// # use the_lib::render::graphics::{UnderlineStyle, Style};
  ...
  /// Results in a combined style that is equivalent to applying the two
  /// individual styles to a style one after the other.
  ///
  /// ## Examples
  /// ```
  /// # use the_lib::render::graphics::{Color, Modifier, Style};
