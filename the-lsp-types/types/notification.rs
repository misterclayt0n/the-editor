...
macro_rules! lsp_notification {
  ("$/cancelRequest") => {
    $crate::types::notification::Cancel
  };
  ("$/setTrace") => {
    $crate::types::notification::SetTrace
  };
  ("$/logTrace") => {
    $crate::types::notification::LogTrace
  };
  ("initialized") => {
    $crate::types::notification::Initialized
  };
  ("exit") => {
    $crate::types::notification::Exit
  };

  ("window/showMessage") => {
    $crate::types::notification::ShowMessage
  };
  ("window/logMessage") => {
    $crate::types::notification::LogMessage
  };
  ("window/workDoneProgress/cancel") => {
    $crate::types::notification::WorkDoneProgressCancel
  };

  ("telemetry/event") => {
    $crate::types::notification::TelemetryEvent
  };

  ("textDocument/didOpen") => {
    $crate::types::notification::DidOpenTextDocument
  };
  ("textDocument/didChange") => {
    $crate::types::notification::DidChangeTextDocument
  };
  ("textDocument/willSave") => {
    $crate::types::notification::WillSaveTextDocument
  };
  ("textDocument/didSave") => {
    $crate::types::notification::DidSaveTextDocument
  };
  ("textDocument/didClose") => {
    $crate::types::notification::DidCloseTextDocument
  };
  ("textDocument/publishDiagnostics") => {
    $crate::types::notification::PublishDiagnostics
  };

  ("workspace/didChangeConfiguration") => {
    $crate::types::notification::DidChangeConfiguration
  };
  ("workspace/didChangeWatchedFiles") => {
    $crate::types::notification::DidChangeWatchedFiles
  };
  ("workspace/didChangeWorkspaceFolders") => {
    $crate::types::notification::DidChangeWorkspaceFolders
  };
  ("$/progress") => {
    $crate::types::notification::Progress
  };
  ("workspace/didCreateFiles") => {
    $crate::types::notification::DidCreateFiles
  };
  ("workspace/didRenameFiles") => {
    $crate::types::notification::DidRenameFiles
  };
  ("workspace/didDeleteFiles") => {
    $crate::types::notification::DidDeleteFiles
  };
}

/// The base protocol now offers support for request cancellation. To cancel a
...
/// addition it allows for returning partial results on cancel.
#[derive(Debug)]
pub enum Cancel {}
...
/// debugging messages, the server should send `LogMessage` notifications.
#[derive(Debug)]
pub enum LogTrace {}
...
/// client received the result of the initialize request but before the client
/// is sending any other request or notification to the server. The server can
/// use the initialized notification for example to dynamically register
/// capabilities.
#[derive(Debug)]
...
/// The server should exit with success code 0 if the shutdown request has been
...
/// owning the corresponding server issuing the event.
#[derive(Debug)]
...
/// the client and the server must not try to read the document's truth
...
/// the document's uri points to (e.g. if the document's uri is a file uri
...
/// to the server to cancel a progress initiated on the server side using the
