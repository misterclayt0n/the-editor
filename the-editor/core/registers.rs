...
///
/// Each register corresponds to a `char`. Most chars can be used to store any
/// set of values but a few chars are "special registers". Special registers
/// have unique behaviors when read or written to:
///
