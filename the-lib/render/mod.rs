...
//! construction) that depend on formatting and rendering state. It intentionally
//! lives alongside core logic so consumers can access `the_lib::render::*`
//! without pulling a separate crate.
