...
fn command_hint_label(command: Command) -> String {
  match command {
    ...
    Command::VcsDiffPicker | Command::ChangedFilePicker => "vcs diff picker".to_string(),
    Command::Search => "search".to_string(),
    Command::RSearch => "search backward".to_string(),
    Command::Save => "write file".to_string(),
    Command::Quit => "quit".to_string(),
    Command::LspGotoDeclaration => "goto declaration".to_string(),
    Command::LspGotoDefinition => "goto definition".to_string(),
    Command::LspGotoTypeDefinition => "goto type definition".to_string(),
    Command::LspGotoImplementation => "goto implementation".to_string(),
    ...
    Command::InlineAccept => "inline accept".to_string(),
    Command::InlineAcceptWord => "inline accept word".to_string(),
    Command::InlineAcceptLine => "inline accept line".to_string(),
    Command::InlineDismiss => "inline dismiss".to_string(),
    Command::InlineRetry => "inline retry".to_string(),
...
fn builtin_keymap_map() -> HashMap<Mode, KeyTrie> {
  let normal = crate::keymap!({ "Normal mode"
    ...
    "g" => { "Goto"
      ...
      "D" => lsp_goto_declaration,
      "y" => lsp_goto_type_definition,
      "r" => lsp_references,
      "i" => lsp_goto_implementation,
      "t" => goto_window_top,
  ...
  let insert = crate::keymap!({ "Insert mode"
    ...
    "A-l" => inline_accept,
    "A-k" => inline_accept_word,
    "A-j" => inline_accept_line,
    "A-]" => inline_accept_word,
